...
const interface_1 = require("@models/TextBlocks/interface");
...
router.get(api_1.API_ROUTE_URLS.CREATE_TEXT_BLOCK, (_, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { TextBlocks } = index_1.default;
    const textBlock = yield TextBlocks.create({
        name: "home-section-1",
        textBlocks: [
            {
